<div class="relative mt-3 md:mt-0" x-data="{isOpen:true}" @click.away="isOpen=false">
    ...
    <div wire:loading class="spinner top-0 right-0 mr-4 mt-3"></div>
        ...
        @if(strlen($search)>2)
            <div class="z-50 absolute bg-gray-800 text-sm rounded w-64 mt-4" x-show.transition.opacity="isOpen" @keydown.escape.window="isOpen=false">
                ...
                <ul>
                    ...
                    <li class="border-b border-gray-700">
                        <a
                        href="{{route('movies.show',$result['id'])}}" class="block hover:bg-gray-700 px-3 py-2 flex items-center"
